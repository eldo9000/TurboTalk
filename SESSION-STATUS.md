...
**Current state:** TASK-42 benched. q5_0 (~547 MB) passes quality vs large-v3-turbo (~1.5 GB) but speedup not material enough to promote. large-v3-turbo remains default. q5_0 documented as fast-mode candidate for future "quality vs speed" toggle. TASK-46 also complete: audio.rs post-stop sleep reduced 25 ms → 10 ms (transcribe.rs poll already gone — TASK-47 eliminated per-call whisper-cli). Next: TASK-44 (--audio-ctx bench) or TASK-45 (thread count bench).
