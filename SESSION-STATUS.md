...
**Current state:** TASK-55 landed — hallucination detection filter. Three signals (gzip compression ratio, trigram repetition, non-letter ratio) detect Whisper garbage on silence; rejected transcripts are displayed in the main window with a "⚠ filtered" badge and a toast, paste skipped. 97/97 tests green.
